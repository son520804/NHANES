# This script uses various regression analysis to understand the relationship between 
# blood pressure (as an outcome) and explanatory factors including age, sex, BMI, and ethnicity.  
# This script focuses on fitting linear models using ordinary least squares, with blood
# pressure as the dependent variable, and the explanatory factors as
# covariates (independent variables)
# Some models are just simple linear regression, while others may contain nonlinear terms and interactions.

# Since all of the regression functions are higher than 3-dimensional, we plot E[Y|X] against one component of X, 
# while holding other components of X equal to baseline values. 
# For example, we can plot the fitted mean blood pressure as a function of age, for each sex, 
# for each ethnic group, and for people with average BMI.
